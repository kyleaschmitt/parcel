...
class ParcelDLL(object):
    ...
    def __init__(self):
        ...
        self.read_size_no_encryption.argtypes = (c_void_p, c_int, c_void_p, c_int)
        ...
        self.send_data_no_encryption.argtypes = (c_void_p, c_int, c_void_p, c_int)
